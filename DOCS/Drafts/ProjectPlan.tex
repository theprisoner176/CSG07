...
\begin{figure}[htp]
\centering
\includegraphics[scale=0.50]{ProjectPlan2-3.jpg}
...
\begin{figure}[htp]
\centering
\includegraphics[scale=0.6]{Android_use_case_final.jpg}
...
\begin{figure}[htp]
\centering
\includegraphics[scale=0.60]{website_use_case.jpg}
...
\centering
\includegraphics[scale=0.42]{gant_chart_01.PNG}
\caption{Gantt Chart}
\label{Gantt Chart}
\end{adjustwidth}
\end{figure}
...
\begin{longtable}{|p{2.5cm}|p{1.5cm}|p{5cm}|}
\hline
