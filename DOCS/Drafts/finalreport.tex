...
The program is organised in to Android Activity classes that control the application until a new Activity is started.
\\\\
The initial activity that the user sees is the StartScreen, it presents the user with a button prompting the start of a new walk, this button will start a new activity that creates the walk.
\\\\
...
The majority of  functionality is dealt with by the WalkScreen, it is responsible for providing the user with options about the walk. From here places of interest can be created and added to the current walk.
\\\\
...
Route recording algorithm  \\ 
JSON Encoding \\
See Design Specification SE\_07\_DS
...
\includepdf[scale=	0.95, pages={1-27}, pagecommand={}]{SE_07_PM_01.pdf}
\newgeometry{top=1.5cm, bottom =1.2cm}
\includepdf[scale=	0.95, pages={28}, pagecommand={}, landscape=true]{SE_07_PM_01.pdf}
\restoregeometry
\includepdf[scale=0.95, pages={29-}, pagecommand={}]{SE_07_PM_01.pdf}




\subsection{Revised Design Document}
\includepdf[scale=0.95, pages={1-22}, pagecommand={}]{SE_07_DS_01.pdf}
\newgeometry{top=1.5cm, bottom =1.2cm}
\includepdf[scale=	0.95, pages={23}, pagecommand={}, landscape=true]{SE_07_DS_01.pdf}
\restoregeometry
\includepdf[scale=	0.95, pages={24-}, pagecommand={}]{SE_07_DS_01.pdf}
...
\hline		
	...
	\hline
	2.4&N/A&17/02/2014&Reviewed&RYG1 \\
	\hline
	2.4&N/A&17/02/2014&Corrected grammar. Changed to release&MDA \\
	\hline
\end{longtable}
