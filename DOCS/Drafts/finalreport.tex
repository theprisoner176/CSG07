...
\lhead{Group Project 07 â€“ Final Report}
...
Not much you can change to affect the web. It doesnâ€™t edit much just displays the information. The only real risk is not connecting to the database and retrieving the information.
...
\restoregeometry
\includepdf[scale=0.95, pages={31-32}, pagecommand={}]{ProjectPlan.pdf}
