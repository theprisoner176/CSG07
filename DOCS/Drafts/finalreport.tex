...
\includepdf[scale=	0.95, pages={1-28}, pagecommand={}]{ProjectPlan.pdf}
\newgeometry{top=1.5cm, bottom =1.2cm}
\includepdf[scale=	0.95, pages={29}, pagecommand={}, landscape=true]{ProjectPlan.pdf}
\restoregeometry
\includepdf[scale=0.95, pages={30-32}, pagecommand={}]{ProjectPlan.pdf}

\subsection{Revised Design Document}
\includepdf[scale=0.95, pages={1-22}, pagecommand={}]{DesignSpec.pdf}
\newgeometry{top=1.5cm, bottom =1.2cm}
\includepdf[scale=	0.95, pages={24}, pagecommand={}, landscape=true]{DesignSpec.pdf}
\restoregeometry
\includepdf[scale=	0.95, pages={25-31}, pagecommand={}]{DesignSpec.pdf}
