...
\includepdf[scale=	0.95, pages={1-30}, pagecommand={}]{ProjectPlan.pdf}
\newgeometry{top=1.5cm, bottom =1.2cm}
\includepdf[scale=	0.95, pages={31}, pagecommand={}, landscape=true]{ProjectPlan.pdf}
\restoregeometry
\includepdf[scale=0.95, pages={32-34}, pagecommand={}]{ProjectPlan.pdf}
...
\hline		
	...
	\hline
	2.2&N/A&13/02/2014&Added Test Log &RYG1 \\
	\hline
\end{longtable}
