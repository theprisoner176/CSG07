...
List Tables
\newline
This file displays all data in the tables with now filters and also displays all the tables created along with the table names and column names.
~\\\\
Field Forms
\newline
...
\includepdf[scale=0.95, pages={1-23}, pagecommand={}]{DesignSpec.pdf}
\newgeometry{top=1.5cm, bottom =1.2cm}
